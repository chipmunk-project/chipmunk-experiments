...
if (!(!(1==1&&!(p.tcpseq<maxseq&&1==1))) && 1==1) {if (!(p.tcpseq<maxseq&&1==1)&&1==1 && 1==1) {maxseq=p.tcpseq;
...
int state_0 = 0;
void func(struct Packet p) {
if (!(!(1==1&&!(p.pkt_0<state_0&&1==1)))&&1==1) {if (!(p.pkt_0<state_0&&1==1)&&1==1&&1==1) {state_0=p.pkt_0;
;}
