...
(let ((_n18 (ite (=  _n0  29)  _n17   (ite  _n4  1 0)  ) ))
(let ((_n19 (ite (=  _n0  29)  (ite  _n1  1 0)   _n17  ) ))
(let ((_n20 (ite (=  _n0  29)  _n19   _n17  ) ))
(let ((_n21 (ite (=  _n0  29)  _n20   _n18  ) ))
(let ((_n22 (=   (ite  _n4  1 0)   _n21 ) ))
(implies  (and (and (>= state_group_0_state_0_4_6_0 0) (< state_group_0_state_0_4_6_0 1024 ))  (and (>= pkt_0_3_5_0 0) (< pkt_0_3_5_0 1024 )) )   (and  _n15  _n22 )  )))))))))))))))))))))))))
(check-sat)
(get-model)
(exit)