...
if (!(!(1==1&&!(p.src==3&&1==1))) && 1==1) {if (!(p.src==3&&1==1)&&1==1 && 1==1) {if (1==1&&p.dst==3&&1==1 && 1==1) {p.drop=(established[p.array_index]==0);
...
if (!(!(1==1&&!(p.pkt_1==3&&1==1)))&&1==1) {if (!(p.pkt_1==3&&1==1)&&1==1&&1==1) {if (1==1&&p.pkt_0==3&&1==1&&1==1) {p.pkt_3=(state_0==0);
;}
;}
